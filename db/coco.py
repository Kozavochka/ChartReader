...
#         }
        ...
        # Line + bar dataset: COCO category ids 1 (bar) and 2 (line).
        self._cat_ids = [1, 2]
        self._annotation_mode = self.configs.get("annotation_mode", "default")
        # Map bar -> class 0, line -> class 1 (class 2 unused for pie).
        self._classes = {0: 1, 1: 2}
        self._coco_to_class_map = {1: 0, 2: 1}
